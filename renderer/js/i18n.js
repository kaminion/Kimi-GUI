...
(function () {
  ...
  const TABLE = {
    ko: {
      ...
      'chat.send_title': '전송 (↵)',
      'chat.steer_unsupported': '실행 중에는 스티어할 수 없습니다. 응답이 끝난 후 볼 수 있습니다.',
      'chat.thinking': '사고 과정',
      ...
      'options.swarm.title': 'Swarm — 병렬 서브에이전트로 탐색/작업',
      'panel.close': '패널 닫기',
      ...
      'sidebar.group_delete_body': ' 그룹을 삭제할까요? 대화는 프로젝트 그룹으로 돌아갑니다.',
    ...
    en: {
      ...
      'sidebar.group_delete_body': ' group? Its conversations return to their project groups.',
      ...
      'usage.window_5h_title': 'Five-hour rate-limit window',
    },
  };
